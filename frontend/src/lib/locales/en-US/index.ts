export const enUS = {
  ...
  connectionErrors: {
    ...
    apiDesc: "The CogniFlow API server could not be reached",
    ...
    docLink: "CogniFlow Documentation",
  ...
  settings: {
    ...
    filesHelp: "Once your files are uploaded and processed, they are not required anymore. Most users should allow CogniFlow to delete uploaded files from the upload folder automatically.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "A new version of CogniFlow is available.",
    upToDate: "Up to Date",
    unknown: "Unknown",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure which models to use for different purposes across CogniFlow",
    missingRequiredModels: "Missing required models: {models}. CogniFlow may not function properly without these.",
  ...
  apiKeys: {
    ...
    description: "Store API keys securely in the database to enable AI providers in CogniFlow.",
